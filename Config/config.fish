...
alias neet-ssh="bash /home/lucy/Documents/NEET/ssh_sync.sh"
alias arco-ssh="bash /run/media/lucy/Elements/Arco-Workshop/ssh_sync.sh"
alias script-ssh="bash /run/media/lucy/Elements/SCRIPT/ssh_sync.sh"
